...
class CrudController extends Controller
{
    ...
    private function validateData(Request $r, string $resource, ?int $id = null): array
    {
        return match ($resource) {
            ...
            'services' => $r->validate(['code' => ['required', 'max:50', Rule::unique('services')->ignore($id)], 'name' => 'required|max:255', 'monthly_price' => 'required|numeric|min:0', 'tax_fee' => 'required|numeric|between:0,100', 'description' => 'nullable|string', 'is_active' => 'boolean']),
