...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $menus = [['Tổng quan', '/', 'dashboard.view', 0, 'dashboard'], ['Hộ dân', '/households', 'households.manage', 10, 'home'], ['Dịch vụ', '/services', 'services.manage', 20, 'layers'], ['Tuyến thu', '/routes', 'routes.manage', 30, 'route'], ['Thu phí', '/payments', 'payments.view', 40, 'wallet'], ['Hóa đơn điện tử', '/invoices', 'payments.view', 43, 'receipt'], ['Công nợ', '/debts', 'payments.view', 45, 'alert'], ['Người dùng', '/users', 'users.manage', 50, 'users'], ['Log hệ thống', '/audit-logs', 'settings.manage', 55, 'history'], ['Cấu hình', '/settings', 'settings.manage', 60, 'settings']];
