...
return new class extends Migration
{
    ...
    {
        Schema::table('system_settings', fn (Blueprint $table) => $table->boolean('is_secret')->default(false)->after('type'));
        $settings = [
    ...
    {
        Schema::table('system_settings', fn (Blueprint $table) => $table->dropColumn('is_secret'));
    }
};
