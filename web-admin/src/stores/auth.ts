...
import { api } from '@/api'
export type MenuItem = { id:number; name:string; path:string; icon:string; children?:MenuItem[] }
export type Profile = { id:number; username:string; name:string; email:string; phone?:string|null; date_of_birth?:string|null; gender?:string|null; identity_number?:string|null; address?:string|null; avatar_url?:string|null; permissions:string[]; menus:MenuItem[] }
